...
```
Facilitoi Scrum-prosessia ja varmistaa, että tiimi noudattaa Scrum-
viitekehystä. Poistaa esteitä tiimin työskentelyn tieltä ja auttaa
tiimiä parantamaan prosesseja.
```
